...
export default function CartItem({productInfo}) {
    ...
    return <>
        <div className='flex flex-col sm:flex-row gap-2'>
            <div className="card-item flex flex-col sm:flex-row sm:grow justify-between sm:items-center space-y-4 sm:space-y-0 bg-gray-100 py-4 px-6 rounded-lg">
                <img className='w-full sm:w-24 sm:h-24 object-cover sm:rounded-full border-4 border-white' src={imageCover} alt={title} />
